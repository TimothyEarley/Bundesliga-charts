...
colorMap.set("TSG Hoffenheim", ['#1c63b7', '#1c63b7']);
...
colorMap.set("Bor. Mönchengladbach", ['#000000', '#000000']);
colorMap.set("Bayer Leverkusen", ['#e4210b', '#e4210b']);
colorMap.set("Bayer 04 Leverkusen", ['#e4210b', '#e4210b']);
colorMap.set("1. FSV Mainz 05", ['#e62100', '#e62100']);
colorMap.set("FSV Mainz 05", ['#e62100', '#e62100']);
...
colorMap.set("Rasenballsport Leipzig", ['#e0223c', '#e0223c']);
...
colorMap.set("1. FC Heidenheim", ['#ea3323', '#1a42f5'])
colorMap.set("SV Darmstadt 98", ['#1d499a', '#ffffff'])
colorMap.set("Darmstadt", ['#1d499a', '#ffffff'])
colorMap.set("Darmstadt 98", ['#1d499a', '#ffffff'])
